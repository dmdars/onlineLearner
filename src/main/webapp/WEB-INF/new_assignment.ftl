...
<html>
    ...
    <style>
        ...
        * {
        ...
        .wrapper #Rückung2
        {
            text-indent: 260px;        /*Texteinrückung in die Mitte*/
        }

        .wrapper #Rückung3
        {
            text-indent: 207px;        /*Texteinrückung in die Mitte*/
        }

        .wrapper #Rückung4
        {
            text-indent: 230px;        /*Texteinrückung in die Mitte*/
        }
    ...
    <body>
        ...
        <form id = "form" action ="view_main"  method="GET">
            <div class="wrapper">
                ...
                <table>
                    <tr>
                        <th> <h2 id = "Rückung2"> Aufgabe: </h2></th>
                        <td class = "Leerzeile">
                            <p>  </p>
                        </td>
                    </tr>
                ...
                <table>
                    <tr>
                        <th> <h2 id = "Rückung3"> Beschreibung: </h2></th>
                        <td class = "Leerzeile">
                ...
                <table>
                    <tr>
                        <th> <h2 id = "Rückung4"> abgabetext: </h2></th>
                        <td class = "Leerzeile">
                ...
                <div style = "float:right;" id ="Ebutton" >
                    <a href = "view_main"><button class="button" type ="submit" name="" onclick="myFunction2()">Einreicten</button><a>
                </div><br>
            </div>
        </form>
    </body>
